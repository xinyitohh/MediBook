            ...
            {uploading && (
                <div className="mt-4 w-full px-2">
                    ...
                    <div className="w-full bg-gray-100 rounded-full h-2 overflow-hidden shadow-inner">
                        {/* The colored fill (Turns green when complete!) */}
                        <div
                            className={`h-2 rounded-full transition-all duration-300 ease-out ${uploadProgress === 100 ? "bg-green-500" : "bg-brand-500"
                                }`}
